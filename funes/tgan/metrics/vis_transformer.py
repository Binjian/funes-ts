...
def mixed_wave():
    data_path = '../../../data/output/sine+tri_1213/MIX-20221224-144712/mdl/MIX-vanilla-1000-1000-1000-128-32-3-4-0.001-50-4000'
...
def single_wave():
    ...
    # data_path = '../../../data/output/sine_1213/Sine-20221220-082106/mdl/Sine-vanilla-1000-1000-1000-128-32-3-4-0.001-50-4000'
    data_path = '../../../data/output/tri_1213/TRI-20221220-100230/mdl/TRI-vanilla-1000-1000-1000-128-32-3-4-0.001-50-4000'
...
def sine_metric():
    data_path = '../../../data/output/sine_1209/Sine-20221211-084717/mdl/Sine-vanilla-1000-1000-1000-64-32-3-4-0.001-50-4000'
    ...
    def plot_pos(args):
        ...
        for n,p in model.named_parameters():
            if 'pos_encoder' in n:
                ...
                val = np.reshape(p,(50,32))
                plt.matshow(val, cmap=plt.cm.Blues)
                plt.colorbar()
                plt.title("Ranking")
                plt.show()
    ...
    # # print([MAE.index(i) for i in sorted_data]) # [2005, 1016, 5708, 3132, 7321, 992, 3195, 3131, 4688, 5952, 5904, 7529, 7483, 4253, 2513, 2491]
    # print(len(LOSS))
    # print(f'LOSS: {np.mean(LOSS)}') # LOSS: 0.3669922415584518
    # for p in range(pic_num):
    #     # fake_idx = MAE.index(sorted_data[p])
    #     ori_idx = MAE.index(sorted_data[p])
    #     # ori_idx = sorted_ori_idx[p]
