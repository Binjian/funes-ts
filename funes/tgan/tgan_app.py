...
# Local modules
import funes.tgan
from funes.datautils import real_data_loading
...
def train_eval_module(
    ...
    if args.gradient_type == "vanilla":
        X, T = real_data_loading(args.dat_path + "/ocv_HMZABAAH9MF014494_412_512", args.max_seq_len,["soc","ocv"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sup_epochs", default=3, type=int)
    parser.add_argument("--gan_epochs", default=4, type=int)
    ...
    # Output directories
    out_dir = funes2.tgan.PROJROOT + "/output/" + args.out_subdir
    try:
        os.makedirs(out_dir)
