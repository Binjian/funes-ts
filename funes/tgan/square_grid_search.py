...
import square_tgan_config


vanilla_config = square_tgan_config.get_config()
_CONFIG = config_flags.DEFINE_config_dict("square_tgan_config",vanilla_config)
